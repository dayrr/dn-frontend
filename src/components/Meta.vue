    ...
    <b-row>
      <b-col cols="9">
        ...
        <div v-show="metaInputs.length != 0">
          <b-button block class="text-center mt-4 mb-4" type="button" size="lg" @click="submitForm" variant="primary">
            Submit</b-button>
        </div>
      ...
      <b-col>
        ...
        <div v-show="selectedClass !== null">
          Select a property
          <b-list-group>
            <b-list-group-item v-bind:disabled="prop.disabled" href="#" @click="selectProp(prop, $event)" class="flex-column align-items-start"
              v-for="prop in classProps" v-bind:key="prop.uri">
              <div class="d-flex w-100 justify-content-between">
